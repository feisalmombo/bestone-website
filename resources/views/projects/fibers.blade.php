                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <li class="dropdown submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="project-single.html">Data Center</a></li>
                            </ul>
                        </li>
...
<section class="banner_area">
    <div class="container">
        <div class="banner_inner_text">
            <h4>Fiber Networks</h4>
            <ul>
                <li><a href="{{ URL::asset('/') }}">Home</a></li>
                <li class="active"><a href="{{ URL::asset('/fiber') }}">Fiber Networks</a></li>
            </ul>
        </div>
    </div>
</section>
...
<section class="our_project2_area our_project_three_column">
    ...
    <div class="our_project_details">
        ...
        <div class="col-md-4 col-sm-6 building isolation tiling plumbing">
            <div class="project_item">
                <img src="img/project/project-three-column/project-three-4.jpg" alt="">
                <div class="project_hover">
                    <div class="project_hover_inner">
                        <div class="project_hover_content">
        ...
        <div class="col-md-4 col-sm-6 isolation tiling interior plumbing">
            <div class="project_item">
                <img src="img/project/project-three-column/project-three-5.jpg" alt="">
                <div class="project_hover">
                    <div class="project_hover_inner">
                        <div class="project_hover_content">
        ...
        <div class="col-md-4 col-sm-6 building isolation tiling design plumbing">
            <div class="project_item">
                <img src="img/project/project-three-column/project-three-6.jpg" alt="">
                <div class="project_hover">
                    <div class="project_hover_inner">
                        <div class="project_hover_content">
                            <a href="#"><h4>Water Networks</h4></a>
        ...
        <div class="col-md-4 col-sm-6 building isolation tiling plumbing">
            <div class="project_item">
                <img src="img/project/project-three-column/project-three-7.jpg" alt="">
                <div class="project_hover">
                    <div class="project_hover_inner">
                        <div class="project_hover_content">
                            <a href="#"><h4>Data Center</h4></a>
        ...
        <div class="col-md-4 col-sm-6 isolation tiling interior plumbing">
            <div class="project_item">
                <img src="img/project/project-three-column/project-three-8.jpg" alt="">
                <div class="project_hover">
                    <div class="project_hover_inner">
                        <div class="project_hover_content">
                            <a href="#"><h4>Building and Structures</h4></a>
                            <p>This is how to provide the fiber configuration item of internet with high speed to the client.</p>
                            <a class="view_btn" href="#">View Project</a>
                        </div>
                    </div>
        ...
        <div class="col-md-4 col-sm-6 building isolation tiling design plumbing">
            <div class="project_item">
                <img src="img/project/project-three-column/project-three-9.jpg" alt="">
                <div class="project_hover">
                    <div class="project_hover_inner">
                        <div class="project_hover_content">
                            <a href="#"><h4>Water Networks</h4></a>
