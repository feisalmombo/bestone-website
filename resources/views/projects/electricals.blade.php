...
<section class="banner_area">
    <div class="container">
        <div class="banner_inner_text">
            <h4>Electrical Networks</h4>
            <ul>
                <li><a href="{{ URL::asset('/') }}">Home</a></li>
                <li class="active"><a href="{{ URL::asset('/electrical') }}">Electrical Networks</a></li>
            </ul>
        </div>
    </div>
</section>
